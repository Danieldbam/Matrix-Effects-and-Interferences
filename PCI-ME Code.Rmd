...
output_dir <- "C:/Users/DanielMalheiro/Clinical Microbiomics/Teamwebsted - MS-Omics Team Folder/Daniel/PhD/Manuscript/Deliverables"
...
```{r}
Sup_info <- here("Data","Supplimentary Information_Excel_Sheets.xlsx")
data3<- read_excel(Sup_info, sheet = "Homologue Series")

peak_table1 <- data3 %>%
  select(peak_id, mz, rt) %>%  
  mutate(
...
Sup_info <- here("Data","Supplimentary Information_Excel_Sheets.xlsx")
data4<- read_excel(Sup_info, sheet = "Area")
